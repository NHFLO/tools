...
def get_locations(
    filterId="HHNK_Dijkmon_WEB",
    showAttributes=False,
    documentVersion="1.25",
    documentFormat="PI_JSON",
):
    url = "https://fews.hhnk.nl/FewsWebServices/rest/fewspiservice/v1/locations"
    params = {
        "filterId": filterId,
...
def get_timeseries(
    ...
    **kwargs,
    ...
    url = "https://fews.hhnk.nl/FewsWebServices/rest/fewspiservice/v1/timeseries"
    params = {
        "filterId": filterId,
